...
document.addEventListener("DOMContentLoaded", function() {
    ...
    submitButton.addEventListener('click', function(){
      ...
      if(anon.checked == true){
        ...
        article.innerHTML = "<h2>" + mainTitle + "</h2> <h3>Anonymous Poster</h3> <h5>Today...</h5> <p>" + mainContent + "</p> <br> <h5>I will pass it on by... </h5><p>" + mainPass + "</p> <br> <h3>" + month + "-" + date + "-" + year + "</h3>";

        article1.innerHTML = "<h2>" + mainTitle + "</h2> <h3>Anonymous Poster</h3> <h5>Today...</h5> <p>" + mainContent + "</p> <br> <h5>I will pass it on by... </h5><p>" + mainPass + "</p> <br> <h3>" + month + "-" + date + "-" + year + "</h3>";

      }

      else{

        article.innerHTML = "<h2>" + mainTitle + "</h2> <h3>" + userName + "</h3> <h5>Today...</h5> <p>" + mainContent + "</p> <br> <h5>I will pass it on by... </h5><p>" + mainPass + "</p> <br> <h3>" + month + "-" + date + "-" + year + "</h3>";

        article1.innerHTML = "<h2>" + mainTitle + "</h2> <h3>" + userName + "</h3> <h5>Today...</h5> <p>" + mainContent + "</p> <br> <h5>I will pass it on by... </h5><p>" + mainPass + "</p> <br> <h3>" + month + "-" + date + "-" + year + "</h3>";
      }
